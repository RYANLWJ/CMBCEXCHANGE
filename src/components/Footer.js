    ...
    render() {
        return (<div className="mobile-footer">
            <div className="footer_nav">
                <div className="link_item"><a href="http://m.cmbchina.com/Common/ServiceHotLines.aspx" cname="页脚" oname="服务热线"
                    otype="文字">
                ...
                <div className="link_item"><a href="http://m.cmbchina.com/About/aboutweb.aspx?pageid=yinsitiaokuan" cname="页脚"
                    oname="隐私条款" otype="文字">
                    <div className="icons icons-4"></div>隐私条款
                </a></div>
                <div className="link_item"><a href="http://www.cmbchina.com/?from=mweb" target="_blank" cname="页脚" oname="电脑版"
                    otype="文字">
